...
namespace WechatCloud.Core.Infrastructure
{
    /// <summary>
    ...
    public class AppDomainTypeFinder : ITypeFinder
    {
        ...
        protected IProjectFileProvider _fileProvider;
        ...
        protected virtual void LoadMatchingAssemblies(string directoryPath)
        {
            ...
            foreach (var dllPath in _fileProvider.GetFiles(directoryPath, "*.dll"))
            {
                try
                {
                    ...
                    if (Matches(an.FullName) && !loadedAssemblyNames.Contains(an.FullName)&&!an.FullName.Contains("View"))
                    {
                        App.Load(an);
                    }
